...
>
	<div class="flex items-center gap-2">
		<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-primary"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
		<span class="text-[15px] font-bold tracking-tight">GeoJSON Studio</span>
	</div>
	...
	<div class="flex items-center gap-1.5">
		{#if error}
			<Badge variant="destructive" class="max-w-[160px] truncate text-[11px]">{error}</Badge>
		{/if}
